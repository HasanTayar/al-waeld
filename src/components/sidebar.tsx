        ...
        <div className="space-y-4">
          {routes.map(route => (
            <div 
              ...
              className={`flex items-center gap-4 p-3 rounded-lg cursor-pointer ${location.pathname === route.path ? "bg-blue-500 text-white" : "hover:bg-gray-700 hover:text-white"}`}
            >
